...
#cat(paste('Total events unsuccessful (due to ce1==ce2) are: ',cnt_f, 'please see folder/skipped_ce.csv'),file="folder/FINAL_STATS_CE_INCLUSION.txt",sep="\n",append=TRUE)
cat(paste('Finished R session for CE_boundary calculations of a total of: ',dim(ce_coord)[1]/3,' successful events, please see folder/IGV_ce_inclusion.csv'),file=paste0(folder,"/FINAL_STATS_CE_INCLUSION.txt"),sep="\n",append=TRUE)
...
cat(paste('Total events for which ce_coverage files not found are : ',cnt_cf,' (please see folder/coverage_file_not_found.bed)'),file=paste0(folder,"/FINAL_STATS_CE_INCLUSION.txt"),sep="\n",append=TRUE)
print(paste('Total events unsuccessful (due to ce1==ce2) are: ',cnt_f, ' - Please see file folder/skipped_ce.csv file'))
cat(paste('Total events unsuccessful (due to ce1==ce2)   are: ',cnt_f,' Please see file folder/skipped_ce.csv file. It contains us, ce and ds exon coordinates for each event'),file=paste0(folder,"/FINAL_STATS_CE_INCLUSION.txt"),sep="\n",append=TRUE)
...
cat(paste('Total events successfully processed are: ',cnt_ce+cnt_ir+cnt_ext),file=paste0(folder,"/FINAL_STATS_CE_INCLUSION.txt"),sep="\n",append=TRUE)
...
cat(paste('Out of total: ',cnt_ce+cnt_ir+cnt_ext,' successfull events processed'),file=paste0(folder,"/FINAL_STATS_CE_INCLUSION.txt"),sep="\n",append=TRUE)
cat(paste('            ce_inclusion events are: ',cnt_ce),file=paste0(folder,"/FINAL_STATS_CE_INCLUSION.txt"),sep="\n",append=TRUE)
cat(paste('            ce_extension events are: ',cnt_ext),file=paste0(folder,"/FINAL_STATS_CE_INCLUSION.txt"),sep="\n",append=TRUE)
cat(paste('            IR events are: ',cnt_ir),file=paste0(folder,"/FINAL_STATS_CE_INCLUSION.txt"),sep="\n",append=TRUE)
#}
