...
then
    ...
    then
		...
		echo '#############################'
		echo INVOKING SKIPTICS Script
		echo #############################
		#source esV5_layered.sh sorted_$1 principal_tx2_merged_samples.csv #$2 #clean_"$splicing_events_file".csv #$1 #$2
    source esV5_layered.sh clean_"$splicing_events_file".csv principal_txs.csv #principal_tx2_merged_samples.csv #$2 #clean_majiq_events.csv #$1 #$2

		echo '#############################'
		echo BACK FROM SKIPTICS Script
		echo '#############################'
		echo "################################ DONE SKIPTICS IDENTIFICATION " >> ALL_STATS.txt
		#CALL ggsashimi for SASHIMI PLOTS
